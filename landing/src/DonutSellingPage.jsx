      ...
      <section className="ds-hero" id="top">
        ...
        <div className="ds-container ds-hero__grid">
          <div className="ds-hero__copy">
            ...
            <p className="ds-lede">
              Take WhatsApp orders, manage your menu, accept payments — without writing a single line of code, and without paying 30% commission to anyone.
            </p>
...
function PageStyles() {
  return (
    <style>{`
      ...
      .ds-phone { position: relative; z-index: 1; width: 280px; height: 590px; background: #000; border-radius: 44px; padding: 6px; box-shadow: 0 30px 70px rgba(236,72,153,0.32), 0 8px 20px rgba(0,0,0,0.25); border: 2px solid #2a2a2a; }
      ...
      .ds-phone__frame { width: 100%; height: 100%; border: 0; border-radius: 38px; background: #000; display: block; }
      .ds-phone--big .ds-phone__frame { border-radius: 44px; }
