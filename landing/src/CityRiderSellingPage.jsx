...
const STRINGS = {
  id: {
    ...
    compare: {
      ...
      rows: [
        { feat: 'Komisi per order',        them: 'Komisi + biaya jasa aplikasi tiap order', us: '0% — selamanya' },
    ...
    faq: {
      ...
      items: [
        ...
        ['Bagaimana kalau customer cancel atau tidak bayar?',
         'Itu antara kamu dan customer — kamu bisnis independen. Banyak rider kami minta DP 30% via QRIS sebelum berangkat untuk delivery jauh, atau hanya COD untuk pelanggan langganan. City Rider tidak campur tangan, tapi kami sediakan 8 template balasan WhatsApp untuk handling kasus ini (DP, ETA, batalin sopan, dsb).'],
        ...
        ['Bagaimana City Rider beda dari Gojek atau Grab?',
         'Gojek/Grab adalah perusahaan dispatch — mereka ambil komisi + biaya jasa aplikasi setiap order, tentukan harga, dan algoritma mereka yang assign customer. City Rider bukan dispatch — kita cuma platform listing seperti yellow pages digital. Kamu yang muncul di pencarian customer, kamu yang nego, kamu yang antar, kamu yang dibayar. 0% komisi, kamu pemilik bisnis.'],
        ['Saya bisa kerja Gojek/Grab dan City Rider bersamaan?',
         'Bisa — sepenuhnya. City Rider tidak eksklusif. Banyak rider kami menggunakan kami sebagai pemasukan tambahan di antara order Gojek/Grab, atau hanya online di City Rider untuk customer langganan + premium runs (luar kota, paket besar). Kamu yang atur jam — kami cuma listing.'],
        ['Apakah ada minimum order per bulan?',
         'Tidak ada minimum apapun. Kamu bisa terima 0 order, 1 order, atau 100 order — Rp 30.000/bulan tetap sama, profilemu tetap aktif. Tidak ada rating yang turun karena kurang aktif, tidak ada algoritma yang menghukum kamu karena sibuk dengan platform lain hari itu.'],
        ...
        ['Bisakah City Rider suspend akun saya tanpa alasan?',
         'Tidak. Tidak ada "algoritma" yang menutup akun otomatis. Akun kamu hanya non-aktif kalau: (1) subscription gagal bayar 3 hari berturut-turut, atau (2) terbukti fraud/penipuan customer dengan bukti dari korban. Tidak ada "rating jatuh", tidak ada "trip cancel banyak", tidak ada hukuman silent — kamu selalu tahu kenapa.'],
        ...
        ['Database customer saya — milik saya atau City Rider?',
         'Milik kamu sepenuhnya. Customer Book di dashboard adalah daftar PRIBADI rider. Kami tidak share nomor customer kamu ke rider lain. Bahkan kalau kamu cancel subscription, kamu masih bisa export Customer Book dalam format CSV dari halaman Operations. Itu customer kamu — selamanya.'],
        ...
        ['Saya perlu NPWP, SIUP, atau izin usaha?',
         'Tidak — sebagai kurir motor pribadi (UMKM perorangan informal) kamu tidak butuh izin usaha khusus. Yang WAJIB: SIM C aktif + STNK motor atas nama kamu (atau surat kuasa) + ikuti aturan lalu lintas. Lihat /dashboard/legal di app untuk checklist lengkap, plus apa yang harus dipersiapkan kalau ada razia atau pemeriksaan ETLE.'],
      ],
    },
  ...
  en: {
    ...
    compare: {
      ...
      them: 'Gojek / Grab', us: 'City Rider',
      rows: [
        { feat: 'Commission per order',    them: 'Commission + app service fees per order', us: '0% — forever' },
    ...
    faq: {
      ...
      items: [
        ...
        ['What if a customer cancels or refuses to pay?',
         "That's between you and the customer — you're an independent business. Many of our riders ask for a 30% deposit via QRIS before long-distance trips, or COD-only for known regulars. City Rider doesn't intervene, but we provide 8 standard WhatsApp reply templates for handling these cases (deposit, ETA, polite cancel, etc.)."],
        ...
        ['How is City Rider different from Gojek or Grab?',
         "Gojek/Grab are dispatch companies — they take a commission + app service fees on every order, set the price, and their algorithm assigns customers. City Rider is NOT a dispatcher — we're just a listing platform like digital yellow pages. You appear in customer searches, you negotiate, you deliver, you get paid. 0% commission, you own the business."],
        ['Can I keep working Gojek/Grab and City Rider at the same time?',
         "Yes — completely. City Rider is non-exclusive. Many of our riders use us for extra income between Gojek/Grab orders, or only stay online on City Rider for their regular customers + premium runs (out-of-town, large parcels). You set the hours — we're just a listing."],
        ['Is there a minimum order count per month?',
         "No minimum, at all. You can take 0 orders, 1 order, or 100 — Rp 30,000/month stays the same, your profile stays active. No 'rating' that drops because you're less active, no algorithm punishing you for being busy on another platform that day."],
        ...
        ['Can City Rider suspend my account without warning?',
         'No. There is no algorithm that auto-closes your account. Your account only becomes inactive if: (1) the subscription fails to pay for 3 days in a row, or (2) a customer-fraud claim is proven with evidence from the victim. No "rating drop", no "too many cancels", no silent suspension — you always know why.'],
        ...
        ["Are my customer details mine or City Rider's?",
         "Completely yours. The Customer Book on your dashboard is private to each rider. We don't share your customers' numbers with other riders. Even if you cancel your subscription, you can still export your Customer Book as CSV from the Operations page. Your customers — forever."],
        ...
        ['Do I need NPWP, SIUP, or a business permit?',
         "No — as an independent motorcycle courier (UMKM informal) you don't need any special business licence. What you MUST have: a valid SIM C, STNK in your name (or power-of-attorney), and you follow traffic law. See /dashboard/legal in the app for the full checklist + what to prepare for traffic stops (razia) or ETLE camera checks."],
      ],
    },
