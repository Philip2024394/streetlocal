...
```
streetlocal/supabase/migrations/20260510130000_productslocalemail.sql
```
...
1. As vendor: open `/products/email/?vendor=<slug>`, log in, set your order
