...
const THEME_PRESETS = [
  ...
  // Crafts & Handmade
  { id: 'handicraft', accent: '#e8992c', img: themeImg('Handmade crafts woven baskets pottery ceramics on rustic dark wood table'), label: '#13 Handicrafts', category: 'Handicrafts', countries: ['ID', 'MY', 'TH', 'VN', 'PH'], foodTypes: ['Handicrafts', 'Handmade'] },
                    ...
                    <div style={{ width: 140, height: 250, borderRadius: 20, background: '#1a1a1a', padding: 2, position: 'relative', border: shopTheme === theme.id ? '2px solid #FFD600' : '2px solid #333', boxShadow: shopTheme === theme.id ? '0 0 12px rgba(255,214,0,0.3)' : '0 4px 12px rgba(0,0,0,0.3)' }}>
                      ...
                      <div style={{ width: '100%', height: '100%', borderRadius: 18, overflow: 'hidden', position: 'relative', background: '#000' }}>
                        ...
                        <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', zIndex: 2, padding: '0 8px' }}>
                          <div style={{ width: 56, height: 56, borderRadius: 28, background: theme.accent || '#8DC63F', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 6, border: '2px solid rgba(255,255,255,0.15)' }}>
                            <span style={{ fontSize: 18, fontWeight: 900, color: '#fff' }}>LOGO</span>
                          </div>
                          <div style={{ fontSize: 13, fontWeight: 800, color: '#fff', textShadow: '0 1px 4px rgba(0,0,0,0.9)', textAlign: 'center', lineHeight: 1.1 }}>Your Name</div>
