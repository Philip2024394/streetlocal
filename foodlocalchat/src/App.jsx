...
import DesignStudio from '@shared/components/DesignStudio'
import {
  sendCustomerOrder,
  sendChatText,
  sendSystemStatus,
...
export default function App() {
  ...
  return (
    <div style={S.page}>
      ...
      {designStudio && (
        <DesignStudio
          setDesignStudio={setDesignStudio}
          setHeroEditor={setHeroEditor}
          lsPrefix="foodlocalchat"
          defaultThemeBg="https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/chatgpt-image-may-6-2026-01_19_01-pm.png"
          themePresets={THEME_PRESETS}
          shopName={shopName}
          shopFoodType={shopFoodType}
          shopLogo={shopLogo}
          shopLogoStyle={shopLogoStyle}
          setShopLogoStyle={setShopLogoStyle}
          shopTheme={shopTheme}
          shopOpen={shopOpen}
          logoScale={logoScale} setLogoScale={setLogoScale}
          logoInner={logoInner} setLogoInner={setLogoInner}
          logoOffsetX={logoOffsetX} setLogoOffsetX={setLogoOffsetX}
          logoOffsetY={logoOffsetY} setLogoOffsetY={setLogoOffsetY}
          customTagline={customTagline} setCustomTagline={setCustomTagline}
          heroFont={heroFont} heroColor={heroColor} heroSubColor={heroSubColor}
          landingLayout={landingLayout} setLandingLayout={setLandingLayout}
          overlayOpacity={overlayOpacity} setOverlayOpacity={setOverlayOpacity}
          btnEffect={btnEffect} setBtnEffect={setBtnEffect}
          btnShape={btnShape} setBtnShape={setBtnShape}
          btnColor={btnColor} setBtnColor={setBtnColor}
          btnSize={btnSize} setBtnSize={setBtnSize}
          btnText={btnText} setBtnText={setBtnText}
          promoBanner={promoBanner} setPromoBanner={setPromoBanner}
          promoBannerEnabled={promoBannerEnabled} setPromoBannerEnabled={setPromoBannerEnabled}
          menuBanners={menuBanners} setMenuBanners={setMenuBanners}
          menuBannerIdx={menuBannerIdx}
          menuCardStyle={menuCardStyle} setMenuCardStyle={setMenuCardStyle}
          splashEnabled={splashEnabled} setSplashEnabled={setSplashEnabled}
          configTool={configTool} setConfigTool={setConfigTool}
          configPreviewTab={configPreviewTab} setConfigPreviewTab={setConfigPreviewTab}
          accent={accent} isCustomAccent={isCustomAccent} bgStyle={bgStyle}
          imgError={imgError} S={S}
          vendorId={vendorId} uploadMenuImage={uploadMenuImage}
        />
      )}
