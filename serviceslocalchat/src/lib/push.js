/* Web Push helper for vendor inbox */
...
export async function registerSW() {
  ...
  try {
    const reg = await navigator.serviceWorker.register('/services/chat/sw.js', { scope: '/services/chat/' })
    return reg
  } catch (e) {
...
export async function enableVendorPush(vendorId) {
  ...
  // SW
  let reg = await navigator.serviceWorker.getRegistration('/services/chat/')
