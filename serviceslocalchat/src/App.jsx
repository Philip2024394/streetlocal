...
const THEME_PRESETS = [
  // Home services
  { id: 'cleaning', accent: '#3498DB', img: serviceImg('professional house cleaning service workers in uniform with mop and vacuum'), label: '#1 Cleaning', category: 'Cleaning', countries: ['ID', 'MY', 'SG', 'TH', 'VN', 'PH', 'US', 'GB', 'AU'], foodTypes: ['Cleaning', 'House Cleaning', 'Office Cleaning'] },
  ...
  { id: 'electrician', accent: '#F1C40F', img: serviceImg('electrician working on wires panel with tools'), label: '#3 Electrician', category: 'Electrician', countries: ['ID', 'MY', 'SG', 'TH', 'VN', 'US', 'GB', 'AU', 'DE'], foodTypes: ['Electrician', 'Wiring', 'Electrical'] },
  ...
  // Beauty + wellness
  { id: 'massage', accent: '#E91E63', img: serviceImg('massage therapist hands on back relaxing spa setting'), label: '#10 Massage', category: 'Massage', countries: ['ID', 'MY', 'SG', 'TH', 'VN', 'PH', 'US', 'GB', 'AU'], foodTypes: ['Massage', 'Pijat', 'Spa', 'Therapy'] },
  ...
  { id: 'carwash', accent: '#2980B9', img: serviceImg('car wash detailing service spraying soap on vehicle'), label: '#15 Car Wash', category: 'Car Wash', countries: ['ID', 'MY', 'SG', 'TH', 'US', 'GB', 'AU'], foodTypes: ['Car Wash', 'Auto Detailing', 'Car Care'] },
  ...
  { id: 'tutor', accent: '#9B59B6', img: serviceImg('private tutor teaching student at desk with books'), label: '#20 Tutor', category: 'Tutor', countries: ['ID', 'MY', 'SG', 'TH', 'VN', 'PH', 'US', 'GB'], foodTypes: ['Tutor', 'Les Privat', 'Tutoring', 'Education'] },
