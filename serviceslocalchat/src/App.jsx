...
const THEME_PRESETS = [
  ...
  { id: 'plumbing', accent: '#1B6BA8', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2002_35_55%20PM.png', label: '#2 Plumbing', category: 'Plumbing', countries: ['ID', 'MY', 'SG', 'TH', 'US', 'GB', 'AU', 'DE'], foodTypes: ['Plumbing', 'Pipes', 'Bathroom Repair'], variants: [serviceImg('plumber fixing pipes under sink with tools')] },
  ...
  { id: 'aircon', accent: '#3498DB', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2002_28_18%20PM.png', label: '#4 AC Service', category: 'AC Service', countries: ['ID', 'MY', 'SG', 'TH', 'VN', 'PH', 'US', 'GB', 'AU'], foodTypes: ['AC Service', 'Air Conditioning', 'AC Repair'], variants: [serviceImg('air conditioner technician installing AC unit on wall')] },
  { id: 'carpenter', accent: '#8B4513', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2002_43_27%20PM.png', label: '#5 Carpenter', category: 'Carpenter', countries: ['ID', 'MY', 'SG', 'TH', 'US', 'GB', 'AU'], foodTypes: ['Carpenter', 'Tukang Kayu', 'Woodwork'], variants: [serviceImg('carpenter working with wood saws and tools workshop')] },
  { id: 'painter', accent: '#2ECC71', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2003_14_14%20PM.png', label: '#6 Painter', category: 'Painter', countries: ['ID', 'MY', 'SG', 'TH', 'US', 'GB', 'AU'], foodTypes: ['Painter', 'Wall Painting', 'House Painting'], variants: [serviceImg('house painter painting wall with roller brush')] },
  { id: 'gardening', accent: '#27AE60', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2001_36_46%20PM.png', label: '#7 Gardening', category: 'Gardening', countries: ['ID', 'MY', 'SG', 'TH', 'US', 'GB', 'AU'], foodTypes: ['Gardening', 'Tukang Kebun', 'Landscaping'], variants: [serviceImg('gardener trimming hedges with shears in garden')] },
  { id: 'locksmith', accent: '#7F8C8D', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2003_33_08%20PM.png', label: '#8 Locksmith', category: 'Locksmith', countries: ['ID', 'MY', 'SG', 'TH', 'US', 'GB', 'AU'], foodTypes: ['Locksmith', 'Key Service', 'Lock Repair'], variants: [serviceImg('locksmith working on door lock with tools and keys')] },
  { id: 'pest', accent: '#1ABC9C', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2003_29_27%20PM.png', label: '#9 Pest Control', category: 'Pest Control', countries: ['ID', 'MY', 'SG', 'TH', 'US', 'GB', 'AU'], foodTypes: ['Pest Control', 'Exterminator', 'Insect Control'], variants: ['https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2003_29_54%20PM.png', serviceImg('pest control technician spraying outdoor with equipment')] },
  // Beauty + wellness
  ...
  { id: 'salon', accent: '#FF69B4', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2001_30_07%20PM.png', label: '#11 Salon', category: 'Salon', countries: ['ID', 'MY', 'SG', 'TH', 'VN', 'PH', 'US', 'GB', 'AU'], foodTypes: ['Salon', 'Hair', 'Beauty'], variants: [serviceImg('hair salon stylist cutting hair beauty service')] },
  ...
  { id: 'tattoo', accent: '#1a1a1a', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2003_33_08%20PM.png', label: '#12 Tattoo', category: 'Tattoo', countries: ['ID', 'MY', 'SG', 'TH', 'US', 'GB', 'AU', 'DE'], foodTypes: ['Tattoo', 'Tattoo Studio', 'Body Art'], variants: [serviceImg('tattoo artist working on client arm tattoo studio')] },
  { id: 'yoga', accent: '#8E44AD', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2003_37_27%20PM.png', label: '#13 Yoga Trainer', category: 'Yoga Trainer', countries: ['ID', 'MY', 'SG', 'TH', 'US', 'GB', 'AU'], foodTypes: ['Yoga', 'Fitness', 'Personal Trainer', 'Yoga Trainer'], variants: [serviceImg('yoga instructor in studio leading class fitness')] },
  // Automotive
  { id: 'mechanic', accent: '#dc2626', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2003_40_27%20PM.png', label: '#14 Mechanic', category: 'Mechanic', countries: ['ID', 'MY', 'SG', 'TH', 'VN', 'PH', 'US', 'GB', 'AU'], foodTypes: ['Mechanic', 'Bengkel', 'Auto Repair', 'Car Service'], variants: [serviceImg('auto mechanic working on car engine in garage')] },
  ...
  // Tailored services
  { id: 'photographer', accent: '#1a1a1a', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2003_41_08%20PM.png', label: '#17 Photographer', category: 'Photographer', countries: ['ID', 'MY', 'SG', 'TH', 'VN', 'PH', 'US', 'GB', 'AU'], foodTypes: ['Photographer', 'Wedding Photography', 'Photo Studio'], variants: [serviceImg('professional photographer with camera and studio lighting')] },
  { id: 'tailor', isNew: true, accent: '#8E44AD', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2012,%202026,%2003_05_15%20AM.png', label: '#18 Tailor', category: 'Tailor', countries: ['ID', 'MY', 'SG', 'TH', 'VN', 'PH', 'US', 'GB'], foodTypes: ['Tailor', 'Penjahit', 'Sewing', 'Alterations'], variants: [serviceImg('tailor sewing clothes with sewing machine in workshop')] },
  ...
  { id: 'leather', isNew: true, accent: '#5D2E0D', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2001_11_10%20PM.png', label: '#29 Leather Supplier', category: 'Leather Supplier', countries: ['ID','MY','TH','VN','PH','IN','IT','TR','PK','BD'], foodTypes: ['Leather Supplier','Leather Goods','Tanner','Wholesale Leather'] },
  { id: 'maid', isNew: true, accent: '#E91E63', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2001_12_00%20PM.png', label: '#30 House Maid', category: 'House Maid', countries: ['ID','MY','SG','TH','PH','HK','AE','SA','US','GB','AU'], foodTypes: ['House Maid','Maid Service','Pembantu','Housekeeper','Domestic Helper'] },
  { id: 'motorrent', isNew: true, accent: '#FF6B35', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2001_13_32%20PM.png', label: '#31 Motorbike Rental', category: 'Motorbike Rental', countries: ['ID','TH','VN','PH','MY','LA','KH'], foodTypes: ['Motorbike Rental','Scooter Rental','Sewa Motor','Bike Rental'] },
  { id: 'tourguide', isNew: true, accent: '#16A085', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2001_18_24%20PM.png', label: '#32 Tour Guide', category: 'Tour Guide', countries: ['ID','TH','VN','MY','PH','IN','EG','TR','MX','ES','IT','GR'], foodTypes: ['Tour Guide','Local Guide','Tour Operator','City Tour','Pemandu Wisata'] },
  { id: 'carrent', isNew: true, accent: '#34495E', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2001_20_35%20PM.png', label: '#33 Car Rental', category: 'Car Rental', countries: ['ID','MY','SG','TH','VN','PH','US','GB','AU','DE','FR','AE'], foodTypes: ['Car Rental','Self-Drive Car','Sewa Mobil','Car Hire','Rental Mobil'] },
  { id: 'wedding', isNew: true, accent: '#FFD600', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2001_21_51%20PM.png', label: '#34 Wedding Clothes', category: 'Wedding Clothes', countries: ['ID','MY','TH','VN','PH','IN','SG','US','GB','AU'], foodTypes: ['Wedding Clothes','Wedding Dress','Bridal','Tuxedo','Baju Pengantin','Wedding Suit'] },
  { id: 'barber', isNew: true, accent: '#1a1a1a', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2001_28_40%20PM.png', label: '#35 Barber Shop', category: 'Barber Shop', countries: ['ID','MY','SG','TH','VN','PH','US','GB','AU','TR','DE','IT'], foodTypes: ['Barber Shop','Mens Haircut','Barber','Pangkas Rambut'] },
  { id: 'hairsalon', isNew: true, accent: '#FF69B4', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2001_30_07%20PM.png', label: '#36 Hair Salon', category: 'Hair Salon', countries: ['ID','MY','SG','TH','VN','PH','KR','JP','US','GB','AU'], foodTypes: ['Hair Salon','Hairdresser','Hair Styling','Salon Rambut','Coloring'] },
  { id: 'nailart', isNew: true, accent: '#E91E63', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2001_32_19%20PM.png', label: '#37 Nail Art', category: 'Nail Art', countries: ['ID','MY','SG','TH','VN','PH','KR','JP','US','GB','AU'], foodTypes: ['Nail Art','Manicure','Pedicure','Nail Salon','Kuteks'] },
  { id: 'cardriver', isNew: true, accent: '#2C3E50', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2001_33_43%20PM.png', label: '#38 Car Driver', category: 'Car Driver', countries: ['ID','MY','SG','TH','VN','PH','IN','AE','SA','US','GB','AU'], foodTypes: ['Car Driver','Private Driver','Chauffeur','Sopir Pribadi','Driver Hire'] },
  { id: 'glass', isNew: true, accent: '#3498DB', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2003_05_49%20PM.png', label: '#39 Glass Supplier', category: 'Glass Supplier', countries: ['ID','MY','SG','TH','VN','PH','US','GB','AU'], foodTypes: ['Glass Supplier','Glazier','Window Glass','Kaca','Tukang Kaca'] },
  { id: 'roofrepair', isNew: true, accent: '#A0522D', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2003_09_50%20PM.png', label: '#40 Roof Repairs', category: 'Roof Repairs', countries: ['ID','MY','SG','TH','VN','PH','US','GB','AU'], foodTypes: ['Roof Repair','Roofing','Tukang Atap','Genteng','Leak Repair'] },
  { id: 'plastering', isNew: true, accent: '#BDC3C7', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2003_12_28%20PM.png', label: '#41 Plastering', category: 'Plastering', countries: ['ID','MY','SG','TH','VN','PH','US','GB','AU'], foodTypes: ['Plastering','Plasterer','Wall Plaster','Tukang Plester','Render'] },
  { id: 'propertysales', isNew: true, accent: '#16A085', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2003_24_39%20PM.png', label: '#42 Property Sales', category: 'Property Sales', countries: ['ID','MY','SG','TH','VN','PH','US','GB','AU','AE','HK'], foodTypes: ['Property Sales','Real Estate','House for Sale','Agen Properti','Jual Rumah'] },
  { id: 'propertyrentals', isNew: true, accent: '#2980B9', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2003_26_11%20PM.png', label: '#43 Property Rentals', category: 'Property Rentals', countries: ['ID','MY','SG','TH','VN','PH','US','GB','AU','AE','HK'], foodTypes: ['Property Rental','Rent','House Rental','Sewa Rumah','Rumah Disewakan'] },
  { id: 'website', isNew: true, accent: '#3498DB', img: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%2011,%202026,%2003_47_59%20PM.png', label: '#44 Website Services', category: 'Website Services', countries: ['ID','MY','SG','TH','VN','PH','US','GB','AU','DE','FR','AE','IN'], foodTypes: ['Website Services','Web Design','Web Developer','Landing Page','Jasa Website','WordPress'] },
]
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const vid = localStorage.getItem('serviceslocalchat_vendorId')
    if (!vid || String(vid).startsWith('local')) return

    // Auto-heal: detect and fix broken states
    const errors = []
    const theme = localStorage.getItem('serviceslocalchat_theme')
    const accentColor = localStorage.getItem('serviceslocalchat_accentColor')
    const themeBg = localStorage.getItem('serviceslocalchat_themeBg')

    // Fix invalid accent color
    if (accentColor && !/^#[0-9A-Fa-f]{6}$/.test(accentColor)) {
      localStorage.setItem('serviceslocalchat_accentColor', '#8DC63F')
    ...
    if (theme && theme !== 'custom' && !themeBg) {
      ...
      if (preset) { localStorage.setItem('serviceslocalchat_themeBg', preset.img); errors.push('Missing theme bg restored') }
    }
    // Fix NaN prices in menu
    try {
      const menu = JSON.parse(localStorage.getItem('serviceslocalchat_menu') || '[]')
      let fixed = false
      menu.forEach(item => { if (isNaN(item.price) || item.price < 0) { item.price = 0; fixed = true } })
      if (fixed) { localStorage.setItem('serviceslocalchat_menu', JSON.stringify(menu)); errors.push('NaN prices fixed') }
    ...
    supabase.from('vendor_status').select('force_reset, reset_theme, reset_accent').eq('vendor_id', vid).maybeSingle().then(({ data }) => {
      if (data?.force_reset) {
        ...
        if (preset) {
          localStorage.setItem('serviceslocalchat_theme', newTheme)
          localStorage.setItem('serviceslocalchat_themeBg', preset.img)
          localStorage.setItem('serviceslocalchat_accentColor', newAccent)
    ...
    // Report health
    const menuCount = JSON.parse(localStorage.getItem('serviceslocalchat_menu') || '[]').length
  ...
  useEffect(() => {
    ...
    const storedId = localStorage.getItem('serviceslocalchat_vendorId')
  ...
  const [showLanding, setShowLanding] = useState(() => {
    ...
    const id = new URLSearchParams(window.location.search).get('vendor') || localStorage.getItem('serviceslocalchat_vendorId') || localStorage.getItem('indoo_vendor_id')
    return !id
  })
  const [menuItems, setMenuItems] = useState(() => isDemo ? DEMO_MENU : loadJSON('serviceslocalchat_menu', DEMO_MENU))
  ...
  const [isVendor, setIsVendor] = useState(() => {
    ...
    if (urlVendor) {
      localStorage.setItem('serviceslocalchat_vendorId', urlVendor)
      localStorage.setItem('indoo_vendor_id', urlVendor)
      if (urlCity) localStorage.setItem('serviceslocalchat_shopCity', urlCity)
      if (urlCountry) localStorage.setItem('serviceslocalchat_shopCountry', urlCountry)
      // Auto-set delivery rates for new vendors
      const countryCode = params.get('cc')
      if (countryCode && !localStorage.getItem('serviceslocalchat_delRatesSet')) {
        const rates = getDeliveryDefaults(countryCode, urlCity)
        localStorage.setItem('serviceslocalchat_delMin', rates.minCharge)
        localStorage.setItem('serviceslocalchat_delMinKm', rates.minKm)
        localStorage.setItem('serviceslocalchat_delPerKm', rates.perKm)
        localStorage.setItem('serviceslocalchat_delMax', rates.maxKm)
        localStorage.setItem('serviceslocalchat_delCurrency', rates.currency)
        localStorage.setItem('serviceslocalchat_delRatesSet', 'true')
      }
    }
    const id = urlVendor || localStorage.getItem('serviceslocalchat_vendorId') || localStorage.getItem('indoo_vendor_id')
    return !!id
  })
  ...
  const [setupGatewayId, setSetupGatewayId] = useState(null)
  const [paymentGateways, setPaymentGateways] = useState(() => {
    try { return JSON.parse(localStorage.getItem('serviceslocal_payment_gateways') || '{}') } catch { return {} }
  })
  useEffect(() => {
    try { localStorage.setItem('serviceslocal_payment_gateways', JSON.stringify(paymentGateways)) } catch {}
  }, [paymentGateways])
  ...
  const [shopTheme, setShopTheme] = useState(() => urlThemePreset ? urlThemePreset.id : (isDemo || isPreview) ? 'noodle' : (localStorage.getItem('serviceslocalchat_theme') || 'default'))
  const [shopAccentColor, setShopAccentColor] = useState(() => urlThemePreset ? urlThemePreset.accent : (isDemo || isPreview) ? '#8B0000' : (localStorage.getItem('serviceslocalchat_accentColor') || '#8DC63F'))
  ...
  const savedBgPos = (() => { try { return JSON.parse(localStorage.getItem('serviceslocalchat_bgPos')) } catch { return null } })()
  const bgStyle = shopTheme === 'custom' && savedBgPos ? { objectFit: 'cover', objectPosition: `${savedBgPos.x}% ${savedBgPos.y}%` } : { objectFit: 'fill' }
  const [delBaseFee, setDelBaseFee] = useState(() => parseInt(localStorage.getItem('serviceslocalchat_delBase')) || 5000)
  const [delPerKm, setDelPerKm] = useState(() => parseInt(localStorage.getItem('serviceslocalchat_delPerKm')) || 2500)
  const [delMinCharge, setDelMinCharge] = useState(() => parseInt(localStorage.getItem('serviceslocalchat_delMin')) || 7000)
  const [delMaxKm, setDelMaxKm] = useState(() => parseInt(localStorage.getItem('serviceslocalchat_delMax')) || 15)
  const [delFreeAbove, setDelFreeAbove] = useState(() => parseInt(localStorage.getItem('serviceslocalchat_delFree')) || 0)
  const [delCurrency, setDelCurrency] = useState(() => localStorage.getItem('serviceslocalchat_delCurrency') || 'Rp')
  const [delMinKm, setDelMinKm] = useState(() => parseInt(localStorage.getItem('serviceslocalchat_delMinKm')) || 2)
  const [delEnabled, setDelEnabled] = useState(() => localStorage.getItem('serviceslocalchat_delEnabled') !== 'false')

  /* Shop info */
  const [shopName, setShopName] = useState(() => localStorage.getItem('serviceslocalchat_shopName') || 'Street Noodle')
  const [shopLogo, setShopLogo] = useState(() => localStorage.getItem('serviceslocalchat_shopLogo') || 'https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/untitledsadaaaa-removebg-preview.png')
  const [shopLogoStyle, setShopLogoStyle] = useState(() => localStorage.getItem('serviceslocalchat_logoStyle') || 'circle') // circle | bare | off
  const [heroSize, setHeroSize] = useState(() => localStorage.getItem('serviceslocalchat_heroSize') || 'normal') // normal | large | xl
  const [heroFont, setHeroFont] = useState(() => localStorage.getItem('serviceslocalchat_heroFont') || 'system') // system | nunito | poppins | playfair | caveat | bebas
  const [heroColor, setHeroColor] = useState(() => localStorage.getItem('serviceslocalchat_heroColor') || '#ffffff')
  const [heroSubColor, setHeroSubColor] = useState(() => localStorage.getItem('serviceslocalchat_heroSubColor') || '') // empty = auto from heroColor
  const [heroEffect, setHeroEffect] = useState(() => localStorage.getItem('serviceslocalchat_heroEffect') || 'shadow') // shadow | glow | runGlow | outline | neon | none
  const [heroEditor, setHeroEditor] = useState(false) // full editor open
  const [shopPhone, setShopPhone] = useState(() => localStorage.getItem('serviceslocalchat_shopPhone') || '6281234567890')
  const [shopOpen, setShopOpen] = useState(() => loadJSON('serviceslocalchat_shopOpen', true))
  const [shopAddress, setShopAddress] = useState(() => localStorage.getItem('serviceslocalchat_shopAddress') || 'Jl. Malioboro, Yogyakarta')
  const [shopHours, setShopHours] = useState(() => localStorage.getItem('serviceslocalchat_shopHours') || '17:00 – 23:00')
  ...
  const [shopSchedule, setShopSchedule] = useState(() => loadJSON('serviceslocalchat_shopSchedule', defaultSchedule))
  const [shopMapsLink, setShopMapsLink] = useState(() => localStorage.getItem('serviceslocalchat_shopMaps') || '')
  const [shopInstagram, setShopInstagram] = useState(() => localStorage.getItem('serviceslocalchat_shopIG') || 'lummeenoodles')
  const [shopTiktok, setShopTiktok] = useState(() => localStorage.getItem('serviceslocalchat_shopTT') || 'lummeenoodles')
  const [shopFacebook, setShopFacebook] = useState(() => localStorage.getItem('serviceslocalchat_shopFB') || 'lummeenoodles')
  const [shopYoutube, setShopYoutube] = useState(() => localStorage.getItem('serviceslocalchat_shopYT') || 'lummeenoodles')
  const [shopWebsite, setShopWebsite] = useState(() => localStorage.getItem('serviceslocalchat_shopWeb') || 'www.lummeenoodles.com')
  const [shopQris, setShopQris] = useState(() => isDemo ? 'https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/untitledxzxcczdsasdsadads.png' : (localStorage.getItem('serviceslocalchat_shopQris') || 'https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/untitledxzxcczdsasdsadads.png'))
  const [shopBio, setShopBio] = useState(() => localStorage.getItem('serviceslocalchat_shopBio') || '')
  const [shopCity, setShopCity] = useState(() => localStorage.getItem('serviceslocalchat_shopCity') || '')
  const [shopCountry, setShopCountry] = useState(() => localStorage.getItem('serviceslocalchat_shopCountry') || '')
  const [shopFoodType, setShopFoodType] = useState(() => localStorage.getItem('serviceslocalchat_shopFoodType') || 'Indonesian Street Food')

  /* ─── Customization Features (all optional) ─── */
  const [btnShape, setBtnShape] = useState(() => localStorage.getItem('serviceslocalchat_btnShape') || 'rounded')
  const [btnColor, setBtnColor] = useState(() => localStorage.getItem('serviceslocalchat_btnColor') || '')
  const [btnText, setBtnText] = useState(() => localStorage.getItem('serviceslocalchat_btnText') || '')
  const [btnGlow, setBtnGlow] = useState(() => localStorage.getItem('serviceslocalchat_btnGlow') === 'true')
  const [overlayOpacity, setOverlayOpacity] = useState(() => parseInt(localStorage.getItem('serviceslocalchat_overlayOpacity')) || 40)
  const [landingLayout, setLandingLayout] = useState(() => localStorage.getItem('serviceslocalchat_landingLayout') || 'center')
  const [customTagline, setCustomTagline] = useState(() => localStorage.getItem('serviceslocalchat_customTagline') || '')
  const [menuCardStyle, setMenuCardStyle] = useState(() => localStorage.getItem('serviceslocalchat_menuCardStyle') || 'horizontal')
  const [menuBanner, setMenuBanner] = useState(() => localStorage.getItem('serviceslocalchat_menuBanner') || '')
  const [showClosedBanner, setShowClosedBanner] = useState(() => localStorage.getItem('serviceslocalchat_showClosedBanner') === 'true')
  const [promoBanner, setPromoBanner] = useState(() => localStorage.getItem('serviceslocalchat_promoBanner') || '')
  const [promoBannerEnabled, setPromoBannerEnabled] = useState(() => localStorage.getItem('serviceslocalchat_promoBannerEnabled') === 'true')
  const [splashEnabled, setSplashEnabled] = useState(() => localStorage.getItem('serviceslocalchat_splashEnabled') === 'true')
  const [showSplash, setShowSplash] = useState(() => localStorage.getItem('serviceslocalchat_splashEnabled') === 'true')
  ...
  const [dailyDeals, setDailyDeals] = useState(() => loadJSON('serviceslocalchat_dailyDeals', []))
  const [showCustomers, setShowCustomers] = useState(false)
  const [installDismissed, setInstallDismissed] = useState(() => localStorage.getItem('serviceslocalchat_installDismissed') === 'true')
  ...
  /* In-app chat state (serviceslocalchat) */
  ...
  /* Vendor inbox state (serviceslocalchat) */
  ...
  const [vendorChimePrimed, setVendorChimePrimed] = useState(() => localStorage.getItem('serviceslocalchat_chimePrimed') === 'true')
  ...
  const [showVisitUsWA, setShowVisitUsWA] = useState(() => localStorage.getItem('serviceslocalchat_showVisitUsWA') === 'true')
  ...
  const [vendorId, setVendorId] = useState(() => new URLSearchParams(window.location.search).get('vendor') || localStorage.getItem('serviceslocalchat_vendorId') || localStorage.getItem('indoo_vendor_id') || null)
  ...
  // Progressive-disclosure fields — services-themed
  const [formPhotos, setFormPhotos] = useState([])
  const [formAllergens, setFormAllergens] = useState([])   // Requirements
  const [formDietary, setFormDietary] = useState([])       // Service Tags
  const [formPortion, setFormPortion] = useState('')       // Coverage
  const [formStock, setFormStock] = useState('')
  const [formVariants, setFormVariants] = useState([])     // Duration tiers
    ...
    <div style={{ padding: '0 14px 4px' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, marginBottom: 12 }}>
        {[
          ...
          { key: 'variants', label: '⏱️ Duration' },
          { key: 'modifiers', label: '➕ Add-ons' },
          { key: 'allergens', label: '⚠️ Requirements' },
          { key: 'dietary', label: '🏷️ Service Tags' },
          { key: 'portion', label: '⚖️ Coverage' },
      ...
      {expandedSections.allergens && (
        <div style={{ marginBottom: 12, padding: 10, background: 'rgba(255,255,255,0.03)', borderRadius: 12, border: '1px solid rgba(255,255,255,0.06)' }}>
          <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.5)', marginBottom: 8 }}>Requirements — what the customer must prepare/provide for the service</div>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
            {['Power outlet', 'Water access', 'Parking space', 'Customer present', 'Pet calm', 'Other'].map(a => {
      ...
      {expandedSections.dietary && (
        <div style={{ marginBottom: 12, padding: 10, background: 'rgba(255,255,255,0.03)', borderRadius: 12, border: '1px solid rgba(255,255,255,0.06)' }}>
          <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.5)', marginBottom: 8 }}>Service tags — quick badges customers see at a glance</div>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
            {['Mobile', 'Eco-friendly', 'Same-day', 'Express', 'Premium', 'Insured'].map(d => {
      ...
      {expandedSections.portion && (
        <div style={{ marginBottom: 12, padding: 10, background: 'rgba(255,255,255,0.03)', borderRadius: 12, border: '1px solid rgba(255,255,255,0.06)' }}>
          <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.5)', marginBottom: 8 }}>Coverage / scope</div>
          <input value={formPortion} onChange={(e) => setFormPortion(e.target.value)} placeholder='e.g. Up to 50sqm · Single visit · 1 vehicle' style={{ width: '100%', padding: '10px 12px', borderRadius: 10, border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(255,255,255,0.06)', color: '#fff', fontSize: 13, outline: 'none', boxSizing: 'border-box' }} />
        </div>
      )}
      {expandedSections.stock && (
        <div style={{ marginBottom: 12, padding: 10, background: 'rgba(255,255,255,0.03)', borderRadius: 12, border: '1px solid rgba(255,255,255,0.06)' }}>
          <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.5)', marginBottom: 8 }}>Slots — auto-hides service when 0. Leave blank for unlimited.</div>
      ...
      {expandedSections.variants && (
        <div style={{ marginBottom: 12, padding: 10, background: 'rgba(255,255,255,0.03)', borderRadius: 12, border: '1px solid rgba(255,255,255,0.06)' }}>
          <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.5)', marginBottom: 8 }}>Duration tiers — customer picks one. Price delta added to base.</div>
          {formVariants.map((v, i) => (
            <div key={v.id} style={{ display: 'flex', gap: 6, marginBottom: 6 }}>
              <input value={v.name} onChange={(e) => setFormVariants(p => p.map((x, j) => j === i ? { ...x, name: e.target.value } : x))} placeholder='Name (30 min / 60 min / 90 min)' style={{ flex: 2, padding: '8px 10px', borderRadius: 8, border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(255,255,255,0.06)', color: '#fff', fontSize: 13, outline: 'none', boxSizing: 'border-box' }} />
          ...
          <button type="button" onClick={() => setFormVariants(p => [...p, { id: 'v_' + Date.now(), name: '', priceDelta: 0 }])} style={{ width: '100%', padding: '8px 10px', marginTop: 4, borderRadius: 8, border: '1px dashed rgba(255,255,255,0.18)', background: 'transparent', color: 'rgba(255,255,255,0.6)', fontSize: 12, fontWeight: 600, cursor: 'pointer' }}>+ Add duration</button>
        </div>
      )}
      {expandedSections.modifiers && (
        <div style={{ marginBottom: 12, padding: 10, background: 'rgba(255,255,255,0.03)', borderRadius: 12, border: '1px solid rgba(255,255,255,0.06)' }}>
          <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.5)', marginBottom: 8 }}>Add-ons / extras — customer can pick multiple (each adds to price).</div>
          {formModifiers.map((m, i) => (
            <div key={m.id} style={{ display: 'flex', gap: 6, marginBottom: 6 }}>
              <input value={m.name} onChange={(e) => setFormModifiers(p => p.map((x, j) => j === i ? { ...x, name: e.target.value } : x))} placeholder='Name (Deep clean / Express / Materials)' style={{ flex: 2, padding: '8px 10px', borderRadius: 8, border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(255,255,255,0.06)', color: '#fff', fontSize: 13, outline: 'none', boxSizing: 'border-box' }} />
          ...
          <button type="button" onClick={() => setFormModifiers(p => [...p, { id: 'm_' + Date.now(), name: '', priceDelta: 0 }])} style={{ width: '100%', padding: '8px 10px', marginTop: 4, borderRadius: 8, border: '1px dashed rgba(255,255,255,0.18)', background: 'transparent', color: 'rgba(255,255,255,0.6)', fontSize: 12, fontWeight: 600, cursor: 'pointer' }}>+ Add add-on</button>
        </div>
      )}
    </div>
  )
  ...
  useEffect(() => { if (vendorId) localStorage.setItem('serviceslocalchat_vendorId', vendorId) }, [vendorId])
  useEffect(() => { saveJSON('serviceslocalchat_menu', menuItems) }, [menuItems])
  useEffect(() => { localStorage.setItem('serviceslocalchat_shopName', shopName) }, [shopName])
  useEffect(() => { localStorage.setItem('serviceslocalchat_shopLogo', shopLogo) }, [shopLogo])
  useEffect(() => { localStorage.setItem('serviceslocalchat_logoStyle', shopLogoStyle) }, [shopLogoStyle])
  useEffect(() => { localStorage.setItem('serviceslocalchat_heroSize', heroSize) }, [heroSize])
  useEffect(() => { localStorage.setItem('serviceslocalchat_heroFont', heroFont) }, [heroFont])
  useEffect(() => {
    if (heroFont !== 'system') {
  ...
  useEffect(() => { localStorage.setItem('serviceslocalchat_heroColor', heroColor) }, [heroColor])
  useEffect(() => { localStorage.setItem('serviceslocalchat_heroSubColor', heroSubColor) }, [heroSubColor])
  useEffect(() => { localStorage.setItem('serviceslocalchat_heroEffect', heroEffect) }, [heroEffect])
  useEffect(() => { localStorage.setItem('serviceslocalchat_shopPhone', shopPhone) }, [shopPhone])
  useEffect(() => { saveJSON('serviceslocalchat_shopOpen', shopOpen) }, [shopOpen])
  useEffect(() => { localStorage.setItem('serviceslocalchat_shopAddress', shopAddress) }, [shopAddress])
  useEffect(() => { localStorage.setItem('serviceslocalchat_shopHours', shopHours) }, [shopHours])
  useEffect(() => { localStorage.setItem('serviceslocalchat_shopSchedule', JSON.stringify(shopSchedule)) }, [shopSchedule])
  useEffect(() => { localStorage.setItem('serviceslocalchat_shopMaps', shopMapsLink) }, [shopMapsLink])
  useEffect(() => { localStorage.setItem('serviceslocalchat_shopIG', shopInstagram) }, [shopInstagram])
  useEffect(() => { localStorage.setItem('serviceslocalchat_shopTT', shopTiktok) }, [shopTiktok])
  useEffect(() => { localStorage.setItem('serviceslocalchat_shopFB', shopFacebook) }, [shopFacebook])
  useEffect(() => { localStorage.setItem('serviceslocalchat_shopYT', shopYoutube) }, [shopYoutube])
  useEffect(() => { localStorage.setItem('serviceslocalchat_shopWeb', shopWebsite) }, [shopWebsite])
  useEffect(() => { localStorage.setItem('serviceslocalchat_shopQris', shopQris) }, [shopQris])
  useEffect(() => { localStorage.setItem('serviceslocalchat_shopFoodType', shopFoodType) }, [shopFoodType])
  useEffect(() => { localStorage.setItem('serviceslocalchat_shopBio', shopBio) }, [shopBio])
  useEffect(() => { localStorage.setItem('serviceslocalchat_shopCity', shopCity) }, [shopCity])
  useEffect(() => { localStorage.setItem('serviceslocalchat_shopCountry', shopCountry) }, [shopCountry])
  useEffect(() => { localStorage.setItem('serviceslocalchat_delBase', delBaseFee) }, [delBaseFee])
  useEffect(() => { localStorage.setItem('serviceslocalchat_delPerKm', delPerKm) }, [delPerKm])
  useEffect(() => { localStorage.setItem('serviceslocalchat_delMin', delMinCharge) }, [delMinCharge])
  useEffect(() => { localStorage.setItem('serviceslocalchat_delMax', delMaxKm) }, [delMaxKm])
  useEffect(() => { localStorage.setItem('serviceslocalchat_delFree', delFreeAbove) }, [delFreeAbove])
  useEffect(() => { localStorage.setItem('serviceslocalchat_delCurrency', delCurrency) }, [delCurrency])
  useEffect(() => { localStorage.setItem('serviceslocalchat_delMinKm', delMinKm) }, [delMinKm])
  useEffect(() => { localStorage.setItem('serviceslocalchat_delEnabled', delEnabled) }, [delEnabled])

  /* Customization features persistence */
  useEffect(() => { localStorage.setItem('serviceslocalchat_btnShape', btnShape) }, [btnShape])
  useEffect(() => { localStorage.setItem('serviceslocalchat_btnColor', btnColor) }, [btnColor])
  useEffect(() => { localStorage.setItem('serviceslocalchat_btnText', btnText) }, [btnText])
  useEffect(() => { localStorage.setItem('serviceslocalchat_btnGlow', btnGlow) }, [btnGlow])
  useEffect(() => { localStorage.setItem('serviceslocalchat_overlayOpacity', overlayOpacity) }, [overlayOpacity])
  useEffect(() => { localStorage.setItem('serviceslocalchat_landingLayout', landingLayout) }, [landingLayout])
  useEffect(() => { localStorage.setItem('serviceslocalchat_customTagline', customTagline) }, [customTagline])
  useEffect(() => { localStorage.setItem('serviceslocalchat_menuCardStyle', menuCardStyle) }, [menuCardStyle])
  useEffect(() => { localStorage.setItem('serviceslocalchat_menuBanner', menuBanner) }, [menuBanner])
  useEffect(() => { localStorage.setItem('serviceslocalchat_showClosedBanner', showClosedBanner) }, [showClosedBanner])
  useEffect(() => { localStorage.setItem('serviceslocalchat_promoBanner', promoBanner) }, [promoBanner])
  useEffect(() => { localStorage.setItem('serviceslocalchat_promoBannerEnabled', promoBannerEnabled) }, [promoBannerEnabled])
  useEffect(() => { localStorage.setItem('serviceslocalchat_splashEnabled', splashEnabled) }, [splashEnabled])
  ...
  const handleVendorSignup = async () => {
    ...
    try {
      ...
      localStorage.setItem('serviceslocalchat_shopFoodType', signupCategory)
      ...
      if (matchedTheme) {
        ...
        localStorage.setItem('serviceslocalchat_theme', matchedTheme.id)
        localStorage.setItem('serviceslocalchat_themeBg', matchedTheme.img)
        const bgImg = document.getElementById('app-bg-img')
  ...
  /* --- In-app chat order (serviceslocalchat) --- */
  const sendOrder = async () => {
    ...
    const customers = loadJSON('serviceslocalchat_customers', [])
    ...
    saveJSON('serviceslocalchat_customers', customers)
  ...
  const primeVendorChime = useCallback(() => {
    ...
    if (!vendorChimePrimed) {
      ...
      try { localStorage.setItem('serviceslocalchat_chimePrimed', 'true') } catch {}
    }
  }, [vendorChimePrimed])
  ...
  useEffect(() => {
    try { localStorage.setItem('serviceslocalchat_showVisitUsWA', showVisitUsWA ? 'true' : 'false') } catch {}
    if (supabase && vendorId && !String(vendorId).startsWith('local')) {
  ...
  /* --- Vendor type --- */
  const [vendorType, setVendorType] = useState(() => localStorage.getItem('serviceslocal_vendor_type') || null)
  const [vendorTypePickerOpen, setVendorTypePickerOpen] = useState(false)
  useEffect(() => {
    if (vendorType) {
      try { localStorage.setItem('serviceslocal_vendor_type', vendorType) } catch {}
    }
  }, [vendorType])
  useEffect(() => {
  ...
  /* --- Visit Us FAB --- */
  const [fabExpanded, setFabExpanded] = useState(() => !localStorage.getItem('serviceslocal_visit_seen'))
  useEffect(() => {
    if (!fabExpanded) return
    const t = setTimeout(() => {
      setFabExpanded(false)
      try { localStorage.setItem('serviceslocal_visit_seen', '1') } catch {}
    }, 3000)
  ...
  if (showLanding) {
    return (
      <div style={{ width: '100%', height: '100%', overflow: 'hidden', position: 'relative' }}>
        ...
        <img src={localStorage.getItem('serviceslocalchat_themeBg') || 'https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/chatgpt-image-may-6-2026-01_19_01-pm.png'} alt="" onError={imgError('theme')} style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', ...bgStyle }} />
  ...
  return (
    <div style={S.page}>
      ...
      <div style={{ paddingBottom: 12 }}>
        {/* Category text toggles + (burger when >4 categories) */}
        <div style={{ display: 'flex', alignItems: 'center', padding: '20px 16px 0' }}>
          ...
          {(() => {
            ...
            const tabs = [{ label: 'Services', filter: 'All' }, ...inlineCats.map(c => ({ label: friendly(c), filter: c }))]
            return tabs.map(tab => {
          ...
          <>
            ...
            <div role="dialog" aria-label="Pick vendor type" style={{
              ...
              <div style={{ textAlign: 'center', marginBottom: 18 }}>
                <div style={{ fontSize: 20, fontWeight: 800, color: '#fff', marginBottom: 4 }}>What kind of service do you offer?</div>
                <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.5)', fontWeight: 500 }}>We'll set up your service categories instantly.</div>
              </div>
        ...
        {menuDrawerOpen && (
          <>
            ...
            <div role="dialog" aria-label="Browse services" style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 18, paddingBottom: 14, borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                <div>
                  <div style={{ fontSize: 19, fontWeight: 800, color: '#fff', letterSpacing: 0.2 }}>Our Services</div>
                  <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.45)', fontWeight: 500, marginTop: 2 }}>{MENU_CATEGORIES.length - 1} categories · {menuItems.length} services</div>
                </div>
              ...
              {[{ filter: 'All', label: 'All Services' }, ...MENU_CATEGORIES.slice(1).map(c => ({ filter: c, label: c === 'Drink' ? 'Drinks' : c === 'Snack' ? 'Snacks' : c === 'Extra Sauce' ? 'Extra' : c }))].map(opt => {
      ...
      {itemModal && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, zIndex: 200 }} onClick={() => setItemModal(null)}>
          ...
          <img src={localStorage.getItem('serviceslocalchat_themeBg') || 'https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/chatgpt-image-may-6-2026-01_19_01-pm.png'} alt="" onError={imgError('theme')} style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'fill', zIndex: 0 }} />
          ...
          <div style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: 480, margin: '0 auto', overflowY: 'auto', height: '100%' }} onClick={(e) => e.stopPropagation()}>
            ...
            {/* Hero image — with side padding + rounded + optional gallery strip */}
            ...
            <div style={{ margin: '-20px 12px 0', background: 'rgba(0,0,0,0.75)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', borderRadius: 20, padding: '20px 18px', position: 'relative', border: isCustomAccent ? `1px solid ${accent}40` : '1px solid rgba(255,255,255,0.08)' }}>
              ...
              {/* Badges — popular, halal, service tags */}
              <div style={{ display: 'flex', gap: 8, marginBottom: 12, flexWrap: 'wrap' }}>
                ...
                {itemModal.halal && <span style={{ fontSize: 11, fontWeight: 700, background: 'rgba(34,197,94,0.15)', color: '#22c55e', padding: '4px 10px', borderRadius: 8 }}>☪️ Halal</span>}
                {(itemModal.dietary || []).map(d => (
                  <span key={d} style={{ fontSize: 11, fontWeight: 700, background: 'rgba(34,197,94,0.12)', color: '#86efac', padding: '4px 10px', borderRadius: 8 }}>🏷️ {d}</span>
                ))}
                ...
                {itemModal.stock != null && itemModal.stock > 0 && itemModal.stock <= 5 && (
                  <span style={{ fontSize: 11, fontWeight: 700, background: 'rgba(239,68,68,0.15)', color: '#fca5a5', padding: '4px 10px', borderRadius: 8 }}>Only {itemModal.stock} slots left</span>
                )}
              </div>
              {/* Requirements panel */}
              {(itemModal.allergens || []).length > 0 && (
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 12px', marginBottom: 14, background: 'rgba(239,68,68,0.08)', border: '1px solid rgba(239,68,68,0.2)', borderRadius: 10 }}>
                  ...
                  <span style={{ fontSize: 11, color: '#fca5a5', fontWeight: 600 }}>You'll need: {(itemModal.allergens || []).join(', ')}</span>
                </div>
              )}
            ...
            {itemModal.variants && itemModal.variants.length > 0 && (
              <div style={{ padding: '0 14px 12px' }}>
                <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.5)', marginBottom: 8, fontWeight: 700, textTransform: 'uppercase', letterSpacing: 0.4 }}>Duration · choose one</div>
      ...
      {showLocation && (() => {
        ...
        <div style={{ position: 'fixed', inset: 0, zIndex: 250 }}>
          <img src={localStorage.getItem('serviceslocalchat_themeBg') || 'https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/chatgpt-image-may-6-2026-01_19_01-pm.png'} alt="" onError={imgError('theme')} style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'fill', zIndex: 0, pointerEvents: 'none' }} />
            ...
            <div style={{ margin: '0 14px 24px', background: 'rgba(0,0,0,0.65)', borderRadius: 20, padding: 20, border: isCustomAccent ? `1px solid ${accent}30` : '1px solid rgba(255,255,255,0.06)' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 14 }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  {/* WhatsApp on Visit Us — only when vendor opts in (serviceslocalchat) */}
              ...
              <div style={{ position: 'relative' }}>
                ...
                <div style={{ width: 200, height: 400, borderRadius: 30, background: '#1a1a1a', padding: 3, position: 'relative', boxShadow: `0 12px 40px ${accent}20, 0 4px 16px rgba(0,0,0,0.3)`, border: '2px solid #333' }}>
                  ...
                  <div style={{ width: '100%', height: '100%', borderRadius: 27, overflow: 'hidden', position: 'relative', background: '#000' }}>
                    ...
                    {/* Background image */}
                    <img src={localStorage.getItem('serviceslocalchat_themeBg') || ''} alt="" onError={imgError('theme')} style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'fill' }} />
        ...
        <div style={{ position: 'fixed', inset: 0, zIndex: 600, background: '#ffffff', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', padding: '8px 16px 24px', gap: 12 }}>
            <button onClick={() => {
              ...
              localStorage.setItem('serviceslocalchat_theme', 'custom'); localStorage.setItem('serviceslocalchat_themeBg', themeEditor.url)
              localStorage.setItem('serviceslocalchat_accentColor', editorColor); localStorage.setItem('serviceslocalchat_bgPos', JSON.stringify(editorPos))
              const bgImg = document.getElementById('app-bg-img')
        ...
        <div style={{ position: 'fixed', inset: 0, zIndex: 600, background: 'linear-gradient(180deg, #1a1a1f 0%, #0c0c10 100%)', display: 'flex', flexDirection: 'column', maxWidth: 480, margin: '0 auto', overflowY: 'auto' }}>
          ...
          <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            <div style={{ background: 'rgba(0,0,0,0.45)', backdropFilter: 'blur(8px)', WebkitBackdropFilter: 'blur(8px)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: 14, boxShadow: '0 4px 14px rgba(0,0,0,0.25)' }}>
              ...
              <button type="button" onClick={() => setShowVisitUsWA(!showVisitUsWA)} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', padding: '10px 14px', borderRadius: 12, minHeight: 44, background: showVisitUsWA ? `${accent}20` : 'rgba(255,255,255,0.04)', border: showVisitUsWA ? `1px solid ${accent}55` : '1px solid rgba(255,255,255,0.1)', color: '#fff', fontSize: 13, fontWeight: 700, cursor: 'pointer', transition: 'all 150ms ease' }}>
                <span>Show WhatsApp link</span>
                <span style={{ width: 38, height: 22, borderRadius: 11, padding: 2, background: showVisitUsWA ? accent : 'rgba(255,255,255,0.18)', position: 'relative', transition: 'background 150ms ease', display: 'inline-block' }}>
                  <span style={{ display: 'block', width: 18, height: 18, borderRadius: 9, background: '#fff', transform: showVisitUsWA ? 'translateX(16px)' : 'translateX(0)', transition: 'transform 150ms ease' }} />
                </span>
              </button>
            </div>
          </div>
              ...
              const renderThemeCard = (theme) => (
                <div key={theme.id} style={{ flexShrink: 0, width: 160, position: 'relative' }}>
                  <button onClick={() => {
                    ...
                    localStorage.setItem('serviceslocalchat_theme', theme.id)
                    localStorage.setItem('serviceslocalchat_themeBg', theme.img)
                    localStorage.setItem('serviceslocalchat_accentColor', theme.accent || '#8DC63F')
                    const bgImg = document.getElementById('app-bg-img')
                  ...
                  <div onClick={(e) => { e.stopPropagation(); setThemeEditor({ url: theme.img }); setEditorColor(theme.accent || '#8DC63F'); setEditorBaseColor(theme.accent || '#8DC63F'); setShopTheme(theme.id); setShopAccentColor(theme.accent || '#8DC63F'); localStorage.setItem('serviceslocalchat_theme', theme.id); localStorage.setItem('serviceslocalchat_themeBg', theme.img); localStorage.setItem('serviceslocalchat_accentColor', theme.accent || '#8DC63F'); const bgImg = document.getElementById('app-bg-img'); if (bgImg) bgImg.src = theme.img; setVendorDrawer(false) }} style={{ position: 'absolute', top: -6, right: -6, width: 30, height: 30, borderRadius: 15, background: '#FFD600', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', boxShadow: '0 2px 8px rgba(0,0,0,0.4)', zIndex: 2 }}>
      ...
      {showDeliverySettings && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 300 }}>
          <img src={localStorage.getItem('serviceslocalchat_themeBg') || 'https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/chatgpt-image-may-6-2026-01_19_01-pm.png'} alt="" onError={imgError('theme')} style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', ...bgStyle, zIndex: 0 }} />
          <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', background: 'rgba(0,0,0,0.5)', backdropFilter: 'blur(8px)', WebkitBackdropFilter: 'blur(8px)', zIndex: 0 }} />
            ...
            <div style={{ textAlign: 'center', marginBottom: 16 }}>
              <label style={{ cursor: 'pointer', display: 'inline-block' }}>
                <input type="file" accept="image/*" style={{ display: 'none' }} onChange={async (e) => {
                  ...
                  if (!file) return
                  const url = await uploadMenuImage(vendorId, file)
                  if (url) { setShopLogo(url); localStorage.setItem('serviceslocalchat_shopLogo', url) }
                }} />
                {shopLogo ? (
              ...
              {shopLogo && <button onClick={() => { setShopLogo(''); localStorage.removeItem('serviceslocalchat_shopLogo') }} style={{ background: 'none', border: 'none', color: '#EF4444', fontSize: 12, fontWeight: 700, cursor: 'pointer', marginTop: 4 }}>Remove</button>}
            ...
            <div style={{ textAlign: 'center' }}>
              <label style={{ cursor: 'pointer', display: 'inline-block' }}>
                <input type="file" accept="image/*" style={{ display: 'none' }} onChange={async (e) => {
                  ...
                  if (!file) return
                  const url = await uploadMenuImage(vendorId, file)
                  if (url) { setShopQris(url); localStorage.setItem('serviceslocalchat_shopQris', url) }
                }} />
                {shopQris ? (
              ...
              {shopQris && (
                <div style={{ marginTop: 8 }}>
                  <button onClick={() => { setShopQris(''); localStorage.removeItem('serviceslocalchat_shopQris') }} style={{ background: 'none', border: 'none', color: '#EF4444', fontSize: 12, fontWeight: 700, cursor: 'pointer' }}>Remove QR</button>
                </div>
              )}
            </div>
          </div>
                ...
                const renderPhoneCard = (theme) => (
                  <div key={theme.id} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    <div style={{ width: 140, height: 250, borderRadius: 20, background: '#1a1a1a', padding: 2, position: 'relative', border: shopTheme === theme.id ? '2px solid #FFD600' : '2px solid #333', boxShadow: shopTheme === theme.id ? '0 0 12px rgba(255,214,0,0.3)' : '0 4px 12px rgba(0,0,0,0.3)' }}>
                      <div onClick={(e) => { e.stopPropagation(); setThemeBrowser(false); setShopTheme(theme.id); setShopAccentColor(theme.accent || '#8DC63F'); localStorage.setItem('serviceslocalchat_theme', theme.id); localStorage.setItem('serviceslocalchat_themeBg', theme.img); localStorage.setItem('serviceslocalchat_accentColor', theme.accent || '#8DC63F'); const bgImg = document.getElementById('app-bg-img'); if (bgImg) bgImg.src = theme.img; setEditorColor(theme.accent || '#8DC63F'); setEditorBaseColor(theme.accent || '#8DC63F'); setThemeEditor({ url: theme.img }); }} style={{ position: 'absolute', top: -6, right: -6, width: 24, height: 24, borderRadius: 12, background: '#FFD600', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 8, fontWeight: 900, color: '#1a1a1a', cursor: 'pointer', boxShadow: '0 2px 6px rgba(0,0,0,0.3)', zIndex: 5, lineHeight: 1 }}>DEV</div>
                  ...
                  <div style={{ position: 'fixed', inset: 0, zIndex: 300, background: 'rgba(0,0,0,0.92)', display: 'flex', flexDirection: 'column', alignItems: 'center', overflowY: 'scroll', WebkitOverflowScrolling: 'touch' }} onClick={() => { setThemePreviewId(null); setThemePreviewImg(null) }}>
                    ...
                    <div style={{ display: 'flex', gap: 10, flexShrink: 0, paddingBottom: 20 }} onClick={e => e.stopPropagation()}>
                      ...
                      <button onClick={() => {
                        ...
                        localStorage.setItem('serviceslocalchat_theme', theme.id); localStorage.setItem('serviceslocalchat_themeBg', activeImg); localStorage.setItem('serviceslocalchat_accentColor', theme.accent || '#8DC63F')
      ...
      {designStudio && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 200 }}>
          <img src={localStorage.getItem('serviceslocalchat_themeBg') || ''} alt="" onError={imgError('theme')} style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', ...bgStyle, zIndex: 0 }} />
          <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', background: 'rgba(0,0,0,0.5)', backdropFilter: 'blur(8px)', WebkitBackdropFilter: 'blur(8px)', zIndex: 0 }} />
          <div style={{ position: 'relative', zIndex: 1, width: '100%', height: '100%', maxWidth: 480, margin: '0 auto', overflowY: 'auto' }}>
            {/* Header */}
            <div style={{ display: 'flex', alignItems: 'center', padding: '14px 16px', gap: 10 }}>
            ...
            {(() => {
              ...
              const renderThemeCard = (theme) => (
                <div key={theme.id} style={{ flexShrink: 0, width: 160, position: 'relative' }}>
                  <button onClick={() => { setShopTheme(theme.id); setShopAccentColor(theme.accent || '#8DC63F'); localStorage.setItem('serviceslocalchat_theme', theme.id); localStorage.setItem('serviceslocalchat_themeBg', theme.img); localStorage.setItem('serviceslocalchat_accentColor', theme.accent || '#8DC63F'); const bgImg = document.getElementById('app-bg-img'); if (bgImg) bgImg.src = theme.img }} style={{ border: shopTheme === theme.id ? '3px solid #FFD600' : '3px solid rgba(255,255,255,0.1)', borderRadius: 16, overflow: 'hidden', cursor: 'pointer', padding: 0, background: 'none', width: '100%' }}>
