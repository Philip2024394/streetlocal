# Services Local Chat — Push Notification Setup
...
- Open the customer side: `http://localhost:5177/services/chat/?vendor=<slug>`
- Add items to the cart and tap "Send Order".
- Open the vendor side in a separate browser profile or device:
  `http://localhost:5177/services/chat/?vendor=<slug>` then open the side
