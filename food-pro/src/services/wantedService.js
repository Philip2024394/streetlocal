...
const DEMO_WANTED = [
  { id: 'w1', user_id: 'u1', title: 'iPhone 14 Pro Max', description: 'Looking for a used iPhone 14 Pro Max in good condition. Prefer 256GB, any color.', image_url: 'https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/untitleddsadasaaa.png', category: 'phones_accessories', condition_pref: 'used', target_price: 8000000, city: 'Jakarta', status: 'active', created_at: new Date(Date.now() - 2 * 86400000).toISOString(), expires_at: new Date(Date.now() + 28 * 86400000).toISOString(), user: { display_name: 'Rina S.', avatar_url: null } },
  { id: 'w2', user_id: 'u2', title: 'Yamaha NMAX 2020+', description: 'Need a Yamaha NMAX 2020 or newer for daily commute in Yogyakarta. Budget flexible.', image_url: 'https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/untitleddsadasaaassssdasdcxcasdasdadfssdf.png', category: 'automotive', condition_pref: 'used', target_price: 18000000, city: 'Yogyakarta', status: 'active', created_at: new Date(Date.now() - 1 * 86400000).toISOString(), expires_at: new Date(Date.now() + 29 * 86400000).toISOString(), user: { display_name: 'Budi W.', avatar_url: null } },
  { id: 'w3', user_id: 'u3', title: 'Baby Stroller — Joie or similar', description: 'Looking for a gently used baby stroller. Brands: Joie, Babyzen, or similar quality. Must fold compact.', image_url: 'https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/untitleddsadasaaassssdasdcxc.png', category: 'mom_baby', condition_pref: 'either', target_price: 1500000, city: 'Bali', status: 'active', created_at: new Date(Date.now() - 3 * 86400000).toISOString(), expires_at: new Date(Date.now() + 27 * 86400000).toISOString(), user: { display_name: 'Dewi A.', avatar_url: null } },
  { id: 'w4', user_id: 'u4', title: 'Canon EOS R50 Camera Kit', description: 'Want a Canon EOS R50 body + lens kit. New or like new. For wedding photography side gig.', image_url: 'https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/untitleddsadasaaasss.png', category: 'cameras', condition_pref: 'either', target_price: 12000000, city: 'Surabaya', status: 'active', created_at: new Date(Date.now() - 5 * 86400000).toISOString(), expires_at: new Date(Date.now() + 25 * 86400000).toISOString(), user: { display_name: 'Agus P.', avatar_url: null } },
  { id: 'w5', user_id: 'u5', title: 'Thrifted Leather Jacket', description: 'Looking for a genuine leather jacket size M/L. Vintage or thrift style. Black or brown preferred.', image_url: 'https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/untitleddsadasdasd.png', category: 'mens_fashion', condition_pref: 'used', target_price: 500000, city: 'Bandung', status: 'active', created_at: new Date(Date.now() - 0.5 * 86400000).toISOString(), expires_at: new Date(Date.now() + 30 * 86400000).toISOString(), user: { display_name: 'Rizky M.', avatar_url: null } },
]
