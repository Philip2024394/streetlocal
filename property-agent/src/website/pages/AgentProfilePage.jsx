      ...
      <div className="ws-container">
        ...
        <ScrollReveal delay={0.1}>
          <div style={{ display: 'flex', gap: 12, marginBottom: 24 }}>
            ...
            <a href={`https://wa.me/${(agent.whatsapp || '').replace(/^0/, '62')}`} target="_blank" rel="noopener noreferrer" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none' }}><img src="https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/dfggdfgees-removebg-preview.png" alt="WhatsApp" style={{ height: 48, objectFit: 'contain' }} /></a>
            ...
            {formSent ? (
              ...
              <>
                ...
                <div style={{ display: 'flex', gap: 10 }}>
                  ...
                  <button onClick={() => sendWA(`Halo ${agent.name}, saya ${formName} ingin konsultasi tentang properti. HP: ${formPhone}`)} disabled={!formName.trim() || !formPhone.trim()} style={{ flex: 2, padding: '6px', borderRadius: 12, border: 'none', background: 'transparent', cursor: 'pointer', fontFamily: 'inherit', display: 'flex', alignItems: 'center', justifyContent: 'center', opacity: formName.trim() && formPhone.trim() ? 1 : 0.3 }}><img src="https://fjvafjkzvygkhiwjuvla.supabase.co/storage/v1/object/public/assets/dfggdfgees-removebg-preview.png" alt="Send via WhatsApp" style={{ height: 40, objectFit: 'contain' }} /></button>
                </div>
              </>
            )}
          </div>
