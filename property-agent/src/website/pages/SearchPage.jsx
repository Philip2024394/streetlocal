            ...
            return (
              <ScrollReveal key={l.id} delay={Math.min(i * 0.03, 0.3)}>
                <div className="ws-card" onClick={() => onSelectListing?.(l)} style={{ borderRadius: 16, overflow: 'hidden', background: 'rgba(0,0,0,0.75)', border: '1px solid rgba(255,255,255,0.06)', position: 'relative' }}>
                  {isSold && <div style={{ position: 'absolute', inset: 0, zIndex: 5, background: 'rgba(0,0,0,0.75)', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: 16 }}><img src={l.status === 'sold' ? 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%202,%202026,%2004_45_33%20AM.png' : 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20May%202,%202026,%2004_43_39%20AM.png'} alt={l.status} style={{ width: '55%', maxWidth: 140, objectFit: 'contain', opacity: 0.9 }} /></div>}
